import educationData from '../../assets/cv/education.json';
import experienceData from '../../assets/cv/experience.json';
import skillsData from '../../assets/cv/skills.json';
import projectsData from '../../assets/projects/projects.json';
import externalLink from '../../assets/images/external-link-symbol.png'
  ...
  projects.forEach((project) => {
    ...
    projectElement.innerHTML = `
      <div class="project-header">
        <h4>${project.title}</h4>
        <a href="${project.link}" target="_blank" class="project-icon" title="View Project">
          <img src="${externalLink}" alt="View Project">
        </a>
      </div>
